...
func makeGraph(title, fileIn, fileOut string, ch chan int) {
	...
	dc.DrawStringAnchored("10", (P+S/2)/2, S-(P-10), 0.5, 0.5)
	dc.DrawStringAnchored("20", S/2, S-(P-10), 0.5, 0.5)
	dc.DrawStringAnchored("30", (S/2+S-P)/2, S-(P-10), 0.5, 0.5)
	dc.DrawStringAnchored("40", S-P, S-(P-10), 0.5, 0.5)
	dc.RotateAbout(-1.5708, S/2, S/2)
	dc.DrawStringAnchored("0", P, P-10, 0.5, 0.5)
	dc.DrawStringAnchored("10", (P+S/2)/2, P-10, 0.5, 0.5)
	dc.DrawStringAnchored("20", S/2, P-10, 0.5, 0.5)
	dc.DrawStringAnchored("30", (S-P+S/2)/2, P-10, 0.5, 0.5)
	dc.DrawStringAnchored("40", S-P, P-10, 0.5, 0.5)
